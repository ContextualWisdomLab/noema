...
Protected-main branch-point reference for this refresh: `1742bb9be40b2587d54c1194c539b863abb11d22`. This is a snapshot anchor, not evergreen current authority; live protected `main` must be refetched before any merge, release, deployment, or acquisition claim.
...
→ fresh publication-time State / Checkpoint + Policy / Approval reconciliation
