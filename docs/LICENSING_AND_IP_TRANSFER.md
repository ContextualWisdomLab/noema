...
- active PR #495 adds reproducible npm lockfile license inventory generation, exact coverage ownership, canonical package-path authority and npm dependency/distribution-classification preservation. Until it integrates, that generator remains active-PR truth, not protected-main truth;
