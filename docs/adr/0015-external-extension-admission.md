...
The cost is a local descriptor/policy/canonicalization adapter and reliance on the Worker runtime Web Crypto provider. Noema no longer carries a home-grown security-critical hashing primitive. AppGuardrail and quarantine receipts remain pins, not proof that those owners completed their own product work; EgressWeave and quarantine references remain references, not Noema-operated outbound or isolation control.
