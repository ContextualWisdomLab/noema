...
- A subsequent focused review found `commercial-readiness-noema-review-malformed-successor-authority.test.ts` could still pass its two null assertions for the wrong reason because its supposed predecessor approval also used the rejected bare form. RED `9ed61359102d3604dfa700ce57462a1f717d684c` requires that predecessor fixture alone to produce `approve`; repair `60005b02ef3ab790b8a936c127a32dad2ac45b7b` moves the predecessor and malformed-successor fixtures to the canonical publisher serialization while retaining the later uncredentialed/ambiguous successor expectations.
