...
- treating procedural graph content, digest identity, candidate non-regression, authenticated evaluator handoff, retained history, or `eligibleForApproval` as tool, lifecycle, Policy / Approval, publication, or activation authority;
