...
Current exact-head generation is application CI `34225184459`, reviewer-ci `34225184096`, required Security Scan `34225184081`, and patch-validator-image `34225184104`. These runs are revision-local and predecessor GREEN does not transfer; queued/pending/in-progress status is not merge authority.
