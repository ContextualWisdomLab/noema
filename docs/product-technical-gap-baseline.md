...
## Protected Worker deployment recovery source — issue #611 / merged PR #612
...
| --- | --- | --- | --- | --- | --- | --- |
| P0 | Production deployment recovery authority | split traffic/foreign Worker/stale deployment receipt가 잘못된 복구 mutation 권한으로 사용될 위험 | protected #610 + #612 / issue #611 | source integrated; controlled rehearsal/release evidence open | immutable reviewed release + controlled recovery rehearsal + provider pre/post distribution + smoke/KPI + immutable recovery receipt | immutable reviewed release 이후 actual owner-controlled recovery rehearsal과 immutable evidence 검증 |
