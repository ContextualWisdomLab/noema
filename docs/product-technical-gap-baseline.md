...
Current exact-head generation is application CI `34226928021`, reviewer-ci `34226928282`, required Security Scan `34226928120`, and patch-validator-image `34226928090`. These runs are revision-local and predecessor GREEN does not transfer; queued/pending/in-progress status is not merge authority.
