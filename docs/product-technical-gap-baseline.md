...
남은 위험은 effect start와 durable claim 사이의 경계, bounded transition/provenance receipt, 실제 Durable Object composition 및 exact-head hosted evidence다. 이 항목들이 구현·검증되기 전 #541 또는 #542를 완료로 표시하지 않는다.
