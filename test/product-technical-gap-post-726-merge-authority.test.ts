...
describe("post-726 protected authority convergence", () => {
  it("binds active authority to the new protected main and remaining open lanes", () => {
    ...
    expect(active).toContain("#730 current exact `9e7abdcf3814e209c6c96b9c3c7e1c2484af9440`");
    expect(active).not.toContain("#730 current exact `50d47dae5d9d10fcf13e383b16f89e05ca6e2aea`");
  ...
  it("binds governance candidate to the ordinary restack on the current protected main", () => {
    ...
    expect(row).toContain("candidate #730 exact `9e7abdcf3814e209c6c96b9c3c7e1c2484af9440`");
    expect(row).not.toContain("candidate #730 exact `50d47dae5d9d10fcf13e383b16f89e05ca6e2aea`");
