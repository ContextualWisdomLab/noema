...
describe("post-726 protected authority convergence", () => {
  it("binds active authority to the new protected main and remaining open lanes", () => {
    ...
    expect(active).toContain("#730 current exact `8146360fc10ce23da50344d605138a4d783d77e5`");
    expect(active).not.toContain("#730 current exact `e4ccde409f1792df9842548cca0dd3f9e7e70530`");
  ...
  it("binds governance candidate to the ordinary restack on the current protected main", () => {
    ...
    expect(row).toContain("candidate #730 exact `8146360fc10ce23da50344d605138a4d783d77e5`");
    expect(row).not.toContain("candidate #730 exact `e4ccde409f1792df9842548cca0dd3f9e7e70530`");
