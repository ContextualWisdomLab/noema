...
describe("procedural publication preflight documentation authority", () => {
  it("classifies #603 as protected preflight without granting publication or activation authority", () => {
    expect(adr).toContain("Protected #603 adds a publication-time preflight");
