...
const CURRENT_730_EQUAL_TIMESTAMP_RETRY_AUTHORITY =
...
const CURRENT_730_NOEMA_MARKER_WHITESPACE_AUTHORITY =
...
const CURRENT_730_NOEMA_CREDENTIAL_SERIALIZATION_AUTHORITY =
...
const CURRENT_730_NOEMA_REVIEW_BASE_AUTHORITY =
...
const CURRENT_730_NOEMA_INJECTED_PUBLISHER_BASE_AUTHORITY =
...
function hasCurrentGovernanceCandidate(baseline: string): boolean {
  ...
  return governanceRows.length === 1
    ...
    && governanceRows[0].includes(GOVERNANCE_EQUAL_TIMESTAMP_RETRY_AUTHORITY)
    ...
    && governanceRows[0].includes(GOVERNANCE_NOEMA_MARKER_WHITESPACE_AUTHORITY)
    && governanceRows[0].includes(GOVERNANCE_NOEMA_MARKER_CARDINALITY_AUTHORITY)
    && governanceRows[0].includes(GOVERNANCE_NOEMA_REVIEW_DISMISSAL_AUTHORITY)
    && governanceRows[0].includes(GOVERNANCE_NOEMA_CREDENTIAL_SUCCESSOR_AUTHORITY)
    && governanceRows[0].includes(GOVERNANCE_NOEMA_CREDENTIAL_SERIALIZATION_AUTHORITY)
    && governanceRows[0].includes(GOVERNANCE_NOEMA_REVIEW_BASE_AUTHORITY)
    && governanceRows[0].includes(GOVERNANCE_NOEMA_INJECTED_PUBLISHER_BASE_AUTHORITY)
...
describe("product-technical gap current authority", () => {
  ...
  it("keeps merged #726 out of the active open-lane section and binds current #730", () => {
    ...
    expect(section).toContain(CURRENT_730_EQUAL_TIMESTAMP_RETRY_AUTHORITY);
    ...
    expect(section).toContain(CURRENT_730_NOEMA_MARKER_WHITESPACE_AUTHORITY);
    expect(section).toContain(CURRENT_730_NOEMA_MARKER_CARDINALITY_AUTHORITY);
    expect(section).toContain(CURRENT_730_NOEMA_REVIEW_DISMISSAL_AUTHORITY);
    expect(section).toContain(CURRENT_730_NOEMA_CREDENTIAL_SUCCESSOR_AUTHORITY);
    expect(section).toContain(CURRENT_730_NOEMA_CREDENTIAL_SERIALIZATION_AUTHORITY);
    expect(section).toContain(CURRENT_730_NOEMA_REVIEW_BASE_AUTHORITY);
    expect(section).toContain(CURRENT_730_NOEMA_INJECTED_PUBLISHER_BASE_AUTHORITY);
