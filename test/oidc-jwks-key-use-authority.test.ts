...
const signingKid = "oidc-jwks-key-use-authority";
...
describe("OIDC JWKS key use authority", () => {
  it("rejects an RSA verification key whose JWK declares encryption use", async () => {
