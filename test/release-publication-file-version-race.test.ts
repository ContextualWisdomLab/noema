...
describe("sterile release publication file-version races", () => {
  it("uses one opened-size buffer when asset reads are highly fragmented", () => {
    ...
    expect(readStableRegularFile("evidence", "release asset", 16, fileSystem)).toEqual(payload);
