...
describe("production URL credential authority", () => {
  it.each([
    ...
    "https://logs.acme-corp.com/export?clientsecret=secret",
    "https://logs.acme-corp.com/export?sessiontoken=secret",
    "https://logs.acme-corp.com/export?refreshtoken=secret",
    "https://logs.acme-corp.com/export?accesskeyid=AKIAEXAMPLEVALUE",
    "https://logs.acme-corp.com/export?secretaccesskey=secret",
